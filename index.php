...
<body>
    ...
    <main id="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="stopSection" id="topsection">
                        <div class="col-md-4  d-none d-md-block"> <img src="assets/img/gallery/madhavv.png" alt=""
                                class="spineeimg">
                        </div>
                        <div class="col-md-8 Solution">
                            <div class="section-title text-center">
                                ...
                                <img src="aassets/img/gallery/madhavv.png" alt="" class="spineeimg d-md-none ">
        ...
        <div class="section-title seven pb-0">
            <h1>BENEFITS OF Minimally invasive Spine Surgery</h1>
        </div>
