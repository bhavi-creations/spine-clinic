...
<head>
    ...
    <!-- Favicons -->
    <link href="assets/img/spain/spain_logo.png" rel="icon" />
    ...
    <main id="main">
                    ...
                    <div class="stopSection" id="topsection">
                        ...
                        <div class="col-md-8 Solution">
                            <div class="section-title text-center">
                                ...
                                <img src="assets/img/gallery/madhavv.png" alt="" class="spineeimg d-md-none ">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-md-8 " data-aos="fade-left">
                        ...
                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> &nbsp;DNB Orthopedics from the
                            National Board of Examination (NBE) in New Delhi in the same year - 2021 </p>

                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>&nbsp; Fellowship in Minimally
                            Invasive
                            Spine Surgery (MIS) at prestigious NANAVATI MAX SUPER SPECIALITY Hospital, Mumbai, under
                            the able guidance of Dr. MIHIR BAPAT and his Team. </p>
                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>&nbsp; Endoscopic Spine Surgery
                            training at the famous WOORIDUL Hospital, SOUTH KOREA, with Dr. SANG-Ho-Lee.</p>


                    </div>

                    <div class="col-md-4" data-aos="fade-right" class="">
                        <img src="assets/img/gallery/s1.jpeg" class="img-fluid " alt="" />
                    </div>
                    ...
                    <div class="col-12 " data-aos="fade-left">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>&nbsp; Member of the
                                    Association of
                                    Spine Surgeons of India (ASSI) and participant in the annual conference (ASSICON).
                                </p>
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>&nbsp; Member of the
                                    Endoscopic
                                    Spine
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>&nbsp; Participant in the
                                    Western India
            ...
            <div class="container">
                <div class="section-title text-center seven">
                    ...
                    <h3 class="text-center ">
                        <strong> Minimally invasive Spine Surgery (MIS) </strong>
                    </h3>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center">
                                        <div class="">
                                            ...
                                            <p class="card-text">
                                                With a focus on precision, microscopic spine surgery
                                                advanced microscopes to perform intricate surgeries with enhanced
                                                accuracy.
                                                This approach minimizes tissue damage and promotes better surgical
                                                outcomes.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center  order-2 order-md-1">
                                        <div class="">
                                            ...
                                            <p class="card-text">
                                                Dr. MADHAVA REDDY's expertise in endoscopic spine surgery offers
                                                patients a
                                                less invasive option for treating spine conditions. Using small
                                                incisions
                        ...
                        <div class="card">
                            <div class="card-body opener">
                                <div class="row">
                                    ...
                                    <h5 class="card-title openSpine">Multilevel Degenerative spine</h5>
                        ...
                        <div class="col-8 contaner_inner only_padding_on_right ">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active show" id="Spondyloslithesis">
                                    ...
                                    <p class=" ">Dr. Madhava Reddy specializes in advanced treatments for lumbar disc
                                        prolapse, focusing on personalized care and effective management strategies
                                        tailored to each patient's needs. His expertise encompasses both conservative
                                        and surgical interventions aimed at relieving symptoms and restoring spinal
                                        health.
                                ...
                                <div class="tab-pane" id="Dorsal">
                                    ...
                                    <p class=" ">Lumbar canal stenosis is a condition characterized by narrowing of the
                                        spinal canal in the lower back, typically due to degenerative changes such as
                                        bone spurs or thickened ligaments. This narrowing can compress the spinal nerves
                                        and cause symptoms such as pain, numbness, or weakness in the lower back,
                                        buttocks, and legs.
                                ...
                                <div class="tab-pane" id="Lumbar">
                                    ...
                                    <p class=" "> Spinal trauma and fractures refer to injuries to the spinal column,
                                        which can result from accidents, falls, sports injuries, or underlying medical
                                        conditions. These injuries can range from minor fractures to severe trauma
                                        affecting spinal stability and function.
                                    </p>
                                ...
                                <div class="tab-pane" id="Cervical">
                                    ...
                                    <p class=" ">Spinal tumors are abnormal growths of tissue within the spinal canal or
                                        the bones of the spine. These tumors can be benign (non-cancerous) or malignant
                                        (cancerous) and may originate from the spinal cord, nerve roots, or surrounding
                                        structures. Spinal tumors can cause pain, neurological deficits, and affect
                                ...
                                <div class="tab-pane" id="Myelopaties">
                                    ...
                                    <p class=" ">
                                        Dr. Madhava Reddy is renowned for his specialized expertise in diagnosing and
                                        treating spinal infections. With a focus on comprehensive care and advanced
                                        treatment strategies, he offers personalized solutions tailored to each
                                ...
                                <div class="tab-pane" id="Disc">
                                    ...
                                    <p class=" ">Dr. Madhava Reddy is renowned for his specialized treatments for
                                        cervical myelopathy, focusing on comprehensive care and personalized treatment
                                        plans tailored to each patient's specific condition and needs. His approach
                                        combines advanced medical expertise with a compassionate understanding of the
                                        challenges faced by patients with spinal disorders.</p>
                                ...
                                <div class="tab-pane" id="Fractures">
                                    ...
                                    <p class=" ">
                                        ...
                                        Dr. Madhava Reddy specializes in the comprehensive management of dorsal tumors
                                        and infections, leveraging advanced diagnostic techniques and personalized
                                        treatment strategies to address each patient's unique needs. His expertise
                                        encompasses both surgical and non-surgical interventions aimed at restoring
                                ...
                                <div class="tab-pane" id="Trauma">
                                    ...
                                    <p class=" ">
                                        Dr. Madhava Reddy is renowned for his specialized treatments for cervical disc
                                        prolapse, focusing on comprehensive care and advanced treatment options tailored
                                        to each patient's needs. His expertise spans both conservative management and
                                        surgical interventions aimed at relieving symptoms and restoring spinal health.
                                    </p>
                                ...
                                <div class="tab-pane" id="Tumors">
                                    ...
                                    <p class=" ">
                                        Dr. Madhava Reddy specializes in comprehensive osteoporosis care, focusing on
                                        early diagnosis, personalized treatment plans, and preventive measures. His
                                        expertise encompasses both medical management and lifestyle interventions to
                                        optimize bone health and reduce fracture risks.
                                    </p>
                                ...
                                <div class="tab-pane" id="Infections">
                                    ...
                                    <p class=" ">Dr. Madhava Reddy is renowned for his expertise in the comprehensive
                                        treatment of spinal deformities, focusing on both conservative and surgical
                                ...
                                <div class="tab-pane" id="Kochs">
                                    ...
                                    <p class=" "> Dr. Madhava Reddy is renowned for his expertise in the field of
                                        orthopaedic trauma, dedicating his practice to providing comprehensive care and
                                        advanced treatments for patients with traumatic injuries. With years of
                                        specialized training and experience, Dr. Madhava Reddy offers compassionate care
                                        combined with innovative surgical and non-surgical interventions to restore
                                ...
                                <div class="tab-pane" id="Deformity">
                                    ...
                                    <p class=" ">
                                        Dr. Madhava Reddy is a distinguished specialist known for his expertise in the
                                        treatment of spinal cord injuries. With extensive training and experience in
                                        spinal surgery and neurosurgical techniques, he offers advanced care and
                                        innovative treatments tailored to each patient's unique condition and needs.
                                    </p>
        ...
        <section id="appointment" class="appointment">
            <div class="container">
                ...
                <div class="row ">
                    <div class="col-md-4 d-none d-md-block">
                        <img src="assets/img/spain/appoitment.webp" class="img-fluid appoinment" />
                    </div>
                        ...
                        <form action="appointmentform.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="text" name="name" class="form-control makIn" id="name" placeholder="Your Name" required />
                                </div>
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    <input type="email" class="form-control makIn" name="email" id="email" placeholder="Your Email" required />
                                </div>
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    <input type="tel" class="form-control makIn" name="phone" id="phone" placeholder="Your Phone" required />
                                </div>
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    <input type="date" name="date" class="form-control makIn" id="date" placeholder="Appointment Date" required />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group mt-3">
                                    <select name="department" id="department" class="form-select makIn" required>
                                        ...
                                        <option value="Spondyloslithesis">Spondyloslithesis </option>
                                        <option value="Dorsal">Dorsal </option>
                                        <option value="Lumbar Spine Surgeries">Lumbar Spine Surgeries </option>
                                        <option value="Cervical Spondylosis"> Cervical Spondylosis</option>
                                        <option value="Myelopaties">Myelopaties </option>
                                        <option value="Disc Prolapse">Disc Prolapse </option>
                                        <option value="Fractures">Fractures</option>
                                        <option value="Trauma">Trauma</option>
                                        <option value="Spinal Tumors">Spinal Tumors</option>
                                        <option value="Infections">Infections</option>
                                        <option value="Kochs Spine">Kochs Spine</option>
                                        <option value="Deformity Corrections">Deformity Corrections</option>
                                        <option value="Vertebroplasty">Vertebroplasty</option>
                                        <option value="Kyphoplasty Surgeries">Kyphoplasty Surgeries</option>
                            ...
                            <div class="form-group mt-3">
                                <textarea class="form-control makIn" name="message" rows="5" placeholder="Message (Optional)"></textarea>
                            </div>
                            <div class="my-3">
        ...
        <div class="section-title seven pb-0 d-none d-lg-block">
            <h1 class="">BENEFITS OF Minimally invasive Spine Surgery</h1>

        </div>

        <div class="section-title seven pb-0 d-lg-none">

            <h4 class="simpally_test ">BENEFITS OF MINIMALLY INVASIVE SPINE SURGERY</h4>
        </div>
        ...
        <section id="" class="appointment section-bg">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    <div class="col-md-8">
                        <ul class="Microincision">
                            <li class="Microincision">Microincision - Fast Healing - Less Post-op Pain</li>
                            <li class="Microincision">Minimal Blood Loss</li>
                            <li class="Microincision">Muscle and Spine Preservation</li>
                            <li class="Microincision">Conscious IV Sedation and Local Anesthesia</li>
                            <li class="Microincision">Reduced Infection Risk / Reduced Scarring </li>
                            <li class="Microincision">Mobilization and Discharge within 24hrs</li>
                        </ul>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row spine360">
                    ...
                    <div class="col-md-12 spineCol" data-aos="fade-left">
                        ...
                        <p class="solution "> <i class="fa-solid fa-check"></i> A one stop solution for spine treatment
                            with Minimully invasive and Open Techniques
                        </p>
                        <!-- <p class="solution ">
              <i class="fa-solid fa-check"></i> A one stop solution for spine treatment
                        ...
                        <p class=" solution"> <i class="fa-solid fa-check"></i>Our clinic is associated with a
                            multirange multi level equipped hospitals to ensure patient care at all levels according to
                            patient
                            requirements.n
                        </p>
        ...
        <section id="contact" class="contact">
            ...
            <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3816.1338659390203!2d82.23452777492473!3d16.967964383849534!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a38286d29ab4d8f%3A0x5497a7f1df337003!2sQuality%20Care%20Speciality%20Lab!5e0!3m2!1sen!2sin!4v1720853094890!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div class="container contact_form_section">
                <div class="row mt-5">
                    <div class="col-lg-7 text_contact_are">
                        <div class="row d-flex flex-row justify-content-center">
                            ...
                            <div class="col-md-6 text-center">
                                <h2 class="h_text_form">Address</h2>
                                <p class="p_text_form">
                                    1st Floor, <br />
                                    Quality Care diagnostics, <br />
                                    Chinta Vari Street, <br />
                                    Bhanugudi, Kakinada <br />
                                    Pin no: 533003
                                </p>
                            </div>
                        </div>
