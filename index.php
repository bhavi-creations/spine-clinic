            ...
            <div class="container">
                <div class="row">
                    <div class="stopSection" id="topsection">
                        <div class="col-md-2  d-none d-md-block"> <img src="assets/img/spain/sp2.png" alt=""
                                class="spineeimg">
                        </div>
                        <div class="col-md-8 ">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-md-8 " data-aos="fade-left">
                        ...
                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> Fellowship in Minimally Invasive
                    ...
                    <div class="col-12 " data-aos="fade-left">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> Member of the Endoscopic
                                    Spine
                                    Foundation of India (ESFI). </p>

                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> Member of the Indian
                                    Orthopaedic
                                    Association (IOA).</p>
                            </div>
                            <div class="col-md-6">
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i>Member of the Orthopaedic
                                    Surgery
                                    Society of Andhra Pradesh (OSSAP). </p>
                                <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> Member of the Bombay
                                    Spine
                                    Society (BSS).</p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 d-flex align-items-center">
                                        <div class="">
                                            ...
                                            <p class="card-text">
                                                Where we specialize in advanced orthopedic techniques for improved
                                                patient
