                                    ...
                                    <div class="swiper-slide">
                                        <ul class="nav nav-tabs flex-column">
                                            <li class="nav-item mt-2">
                                                <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#MIS"
                                                    role="tab">
                                                    <h4>MIS</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Endoscopic"
                                                    role="tab">
                                                    <h4>Endoscopic</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Microscopic"
                                                    role="tab">
                                                    <h4>Microscopic</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Keyhole"
                                                    role="tab">
                                                    <h4>Keyhole</h4>
                                                </a>
                                            </li>
                        ...
                        <div class="col-8 contaner_inner only_padding_on_right ">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active show" id="MIS">
                                    <img src="assets/img/spain/mis.jpg" alt="CT Scanner Image"
                                ...
                                <div class="tab-pane" id="Endoscopic">
                                    <img src="assets/img/spain/endoscopic.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius" />
                                ...
                                <div class="tab-pane" id="Microscopic">
                                    <img src="assets/img/spain/microscopic.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius" />
                                ...
                                <div class="tab-pane" id="Keyhole">
                                    <img src="assets/img/spain/keyhole.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius" />
