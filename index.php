...
<body>
    ...
    <div id="carouselExampleFade" data-bs-interval="3000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" id="bb">
            ...
            <div class="carousel-item">
                <img src="assets/img/sliders/Open vs MIS ( minimally invasive )1 (1).png" class="d-block img-fluid"
                    alt="..." />
            </div>
            <div class="carousel-item">
                ...
                <div class="row">
                    <div class="col-md-6 content_padding" data-aos="fade-left">
                        ...
                        <p class=" ">
                            ...
                            Reddy holds both MS Ortho and DNB Ortho degrees, with advanced minimally invasive
                        ...
                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> MS Ortho from Guntur Government
                        ...
                        <p class="about_degree"><i class="fa-solid fa-arrow-right"></i> Fellowship in Minimally Invasive
                            Spine Surgeries (MIS) at prestigious NANAVATHI MAX SUPER SPECIALITY Hospital, Mumbai, under
                            ...
                            <div class="card-body d-flex align-items-center">
                                <div class="row">
                                    ...
                                    <div class="col-7">
                                        ...
                                        <p class="card-text">
                                            Where we specialize in advanced orthopedic techniques for improved patient
                                            outcomes. Tublar surgery represents a state-of-the-art approach, offering
                ...
                <div class="container  sevice_bg_color">
                            ...
                            <div class="swiper mySwiper">
                                <div class="swiper-wrapper" style="padding-bottom: 70px;">
                                    ...
                                    <div class="swiper-slide">
                                        <ul class="nav nav-tabs flex-column">
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Sciatica"
                                                    role="tab">
                                                    <h4>Sciatica</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Spondylosis"
                                                    role="tab">
                                                    <h4>Spondylosis</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab"
                                                    data-bs-target="#Vertebroplasty" role="tab">
                                                    <h4>Vertebroplasty</h4>
                                                </a>
                                            </li>
                                            <li class="nav-item mt-2">
                                                <a class="nav-link" data-bs-toggle="tab" data-bs-target="#Kyphoplasty"
                                                    role="tab">
                  ...
                  <p class=" ">Dr. Madhava Reddy specializes in advanced treatments for lumbar disc prolapse, focusing on personalized care and effective management strategies tailored to each patient's needs. His expertise encompasses both conservative and surgical interventions aimed at relieving symptoms and restoring spinal health.
                                ...
                                <div class="tab-pane" id="Dorsal">
                                    <img src="assets/img/spain/Dorsal.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Lumbar">
                                    <img src="assets/img/spain/Lumbar Spine Surgeries.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Cervical">
                                    <img src="assets/img/spain/Cervical Spondylosis.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Myelopaties">
                                    <img src="assets/img/spain/Myelopaties.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Disc">
                                    <img src="assets/img/spain/Disc Prolapse.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Fractures">
                                    <img src="assets/img/spain/Fractures.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Trauma">
                                    <img src="assets/img/spain/Trauma.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Tumors">
                                    <img src="assets/img/spain/Spinal Tumors.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Infections">
                                    <img src="assets/img/spain/Infections.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Kochs">
                                    <img src="assets/img/spain/Kochs Spine.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Deformity">
                                    <img src="assets/img/spain/Deformity Corrections.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Sciatica">
                                    <img src="assets/img/spain/Sciatica.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Spondylosis">
                                    <img src="assets/img/spain/Spondylosis.jpg" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Vertebroplasty">
                                    <img src="assets/img/spain/Vertebroplasty.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
                                ...
                                <div class="tab-pane" id="Kyphoplasty">
                                    <img src="assets/img/spain/Kyphoplasty Surgeries.webp" alt="CT Scanner Image"
                                        class="img-fluid service_img_radius">
